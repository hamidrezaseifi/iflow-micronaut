...
public class TestThreeTaskWorkflowSaveRequest implements IWorkflowSaveRequest<TestThreeTaskWorkflowEntity> {

  private TestThreeTaskWorkflowEntity workflow;
   ...
   */
  @Override
  public TestThreeTaskWorkflowEntity getWorkflow() {
   ...
   */
  @Override
  public void setWorkflow(final TestThreeTaskWorkflowEntity workflow) {
