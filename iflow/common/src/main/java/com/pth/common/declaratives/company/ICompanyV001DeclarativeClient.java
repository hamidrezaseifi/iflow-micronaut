package com.pth.common.declaratives.company;
...
public interface ICompanyV001DeclarativeClient {
    ...
    HttpResponse<CompanyWorkflowtypeItemOcrSettingPresetListEdo> readCompanyWorkflowtypeItemOcrSettings(@Header String authorization,
                                                                                                        final String companyIdentity);
    ...
    HttpResponse<CompanyWorkflowtypeItemOcrSettingPresetEdo>
        saveCompanyWorkflowtypeItemOcrSettings(@Header String authorization,
                                               @NotBlank @Body @Valid final CompanyWorkflowtypeItemOcrSettingPresetEdo presetEdo);
